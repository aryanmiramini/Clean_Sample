...
{
    public class CustomProblemDetailFactory : ProblemDetailsFactory
    {
        private readonly ApiBehaviorOptions _options;

        public CustomProblemDetailFactory(IOptions<ApiBehaviorOptions> options)
        {
